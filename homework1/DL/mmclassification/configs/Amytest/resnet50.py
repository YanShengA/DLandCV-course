# configs/my_experiments/resnet50_27classes_best_only.py

_base_ = [
    '../_base_/models/resnet50.py',
    '../_base_/datasets/Amy_dataset_bs32.py', # 引用你之前创建的数据集配置
...
model = dict(
    ...
    head=dict(
        num_classes=27,       # 你的类别数
        in_channels=2048,     # ResNet-50 输出通道
